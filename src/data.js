...
export const PACKS = [
  {id:'genetic',    code:'A1',   name:'Genetic Apex',        date:'Oct 2024', hasShiny:false, packs:3,
   img:'/packs/genetic_apex.jpg', pool:{crown:3, star3:3, star2:29, star1:24, d4:15}},
  {id:'mythical',   code:'A1a',  name:'Mythical Island',      date:'Dec 2024', hasShiny:false, packs:1,
   img:'/packs/mythical_island.jpg', pool:{crown:1, star3:1, star2:10, star1:6, d4:5}},
  {id:'spacetime',  code:'A2',   name:'Space-Time Smackdown', date:'Jan 2025', hasShiny:false, packs:2,
   img:'/packs/space_time_smackdown.jpg', pool:{crown:2, star3:2, star2:24, star1:24, d4:10}},
  {id:'triumphant', code:'A2a',  name:'Triumphant Light',     date:'Feb 2025', hasShiny:false, packs:1,
   img:'/packs/triumphant_light.jpg', pool:{crown:1, star3:1, star2:13, star1:6, d4:5}},
  {id:'shining',    code:'A2b',  name:'Shining Revelry',      date:'Mar 2025', hasShiny:true, packs:1,
   img:'/packs/shining_revelry.jpg', pool:{crown:1, star3:1, star2:18, star1:5, d4:9, s2:4, s1:10}},
  {id:'celestial',  code:'A3',   name:'Celestial Guardians',  date:'Apr 2025', hasShiny:true, packs:2,
   img:'/packs/celestial_guradian.jpg', pool:{crown:2, star3:2, star2:28, star1:24, d4:10, s2:8, s1:20}},
  {id:'extradim',   code:'A3a',  name:'Extradim. Crisis',     date:'May 2025', hasShiny:true, packs:1,
   img:'/packs/extradimensional_crisis.jpg', pool:{crown:1, star3:1, star2:12, star1:6, d4:5, s2:4, s1:10}},
  {id:'eevee',      code:'A3b',  name:'Eevee Grove',          date:'Jun 2025', hasShiny:true, packs:1,
   img:'/packs/eevee_grove.jpg', pool:{crown:1, star3:1, star2:13, star1:9, d4:6, s2:4, s1:10}},
  {id:'wisdom',     code:'A4',   name:'Wisdom Sea & Sky',     date:'Jul 2025', hasShiny:true, packs:2,
   img:'/packs/wisdom_of_sea_and_sky.jpg', pool:{crown:2, star3:2, star2:24, star1:24, d4:10, s2:8, s1:20}},
  {id:'secluded',   code:'A4a',  name:'Secluded Springs',     date:'Aug 2025', hasShiny:true, packs:1,
   img:'/packs/secluded_srings.jpg', pool:{crown:1, star3:1, star2:12, star1:6, d4:5, s2:4, s1:10}},
  {id:'deluxe',     code:'A4b',  name:'Deluxe Pack ex',       date:'Sep 2025', hasShiny:false, packs:1,
   img:'/packs/deluxe_pack_ex.jpg', pool:{crown:1, star3:1, star2:16, star1:6, d4:75}},
  {id:'mega',       code:'B1',   name:'Mega Rising',          date:'Oct 2025', hasShiny:true, shinySlot6:true, packs:3,
   img:'/packs/mega_rising.jpg', pool:{crown:3, star3:3, star2:30, star1:27, d4:15, s2:9, s1:33}},
  {id:'crimson',    code:'B1a',  name:'Crimson Blaze',        date:'Dec 2025', hasShiny:true, shinySlot6:true, packs:1,
   img:'/packs/crimson_blaze.jpg', pool:{crown:2, star3:1, star2:11, star1:6, d4:5, s2:4, s1:10}},
  {id:'fantastical',code:'B2',   name:'Fantastical Parade',   date:'Jan 2026', hasShiny:true, shinySlot6:true, packs:1,
   img:'/packs/fantastical_parade.jpg', pool:{crown:2, star3:3, star2:23, star1:24, d4:10, s2:8, s1:20}},
  {id:'megashine',  code:'B2b',  name:'Mega Shine',           date:'Mar 2026', hasShiny:true, shinySlot6:true, packs:1,
   img:'/packs/mega shine.jpg', pool:{crown:2, star3:2, star2:9, star1:6, d4:5, s2:5, s1:24}},
  {id:'pulsing',    code:'B3',   name:'Pulsing Aura',         date:'Apr 2026', hasShiny:true, shinySlot6:true, packs:1, preliminary:true,
